var mleadsnew = 'Ou2RmokeWWaD78YLdNoRgAasTlyk92U8';var cartinfo = {"country":"RU","prices":{"13802":{"KW":{"price":"15.00","percent":"100","dostavka":"5","old_price":"30","geo_code":"KW","geo_name":"\u041a\u0443\u0432\u0435\u0439\u0442","currency":"\u062f\u064a\u0646\u0627\u0631\u200e","currency_code":"KWD","description":"","name":"PolyGel \u0434\u043b\u044f \u043d\u0430\u0440\u0430\u0449\u0438\u0432\u0430\u043d\u0438\u0438 \u043d\u043e\u0433\u0442\u0435\u0439"}}},"tel":[]};var footertext = 'ООО «МОНСТР-МЕДИА» ИНН 7701071884<br>ОГРН 1157746018870<br>г. Москва, пр-т. Ленинградский, д.80, корп. 1<br/><a onclick="javascript: cartPolitika();" style="cursor: pointer;">\u041F\u043E\u043B\u0438\u0442\u0438\u043A\u0430 \u043A\u043E\u043D\u0444\u0438\u0434\u0435\u043D\u0446\u0438\u0430\u043B\u044C\u043D\u043E\u0441\u0442\u0438 </a><br/><a href="http://monsterleads.pro/?utm_source=from_land" target="_blank">MonsterLeads.Pro</a>';function cartFrameInit(params) {
    console.log("init");
    ...
    ;
    iframe.src = 'http://c.cpam.pro/' + landing_id + '/frame?mleads=Ou2RmokeWWaD78YLdNoRgAasTlyk92U8&t=' + parseInt(cartStartTime || 0) + '&product_id=' + product_id + (type !== '' ? '&type=' + type : '') + (params.subtype === 'fast_call' ? '&subtype=fast_call' : '') + (params.tel ? '&tel=' + encodeURIComponent(params.tel) : '');
...
function sendBaseEvent(event) {var http = new XMLHttpRequest();var url = "https://c.cpam.pro/58986/cross_query?&code=&geo_id=1&subid_id=&subid2_id=&subid3_id=&subid4_id=&subid5_id=&event_trigger=true&unique=1&event=" + event;var params = "";http.open("POST", url, true);http.onreadystatechange = function(){if (http.readyState == 4) {}};http.setRequestHeader("Content-type", "application/x-www-form-urlencoded");http.send(params);};try { (function (d, w, c) {
