var mleadsnew = 'tpsEceGdidSFEczKDywEKTo9JyEJDYc8';var cartinfo = {"country":"RU","prices":{"9209":{"RU":{"price":"1290.00","percent":"100","dostavka":"450","old_price":"2580","geo_code":"RU","geo_name":"\u0420\u043e\u0441\u0441\u0438\u044f","currency":"\u0440\u0443\u0431","currency_code":"RUB","description":"\u0427\u0438\u0441\u0442\u044f\u0449\u0435\u0435 \u0441\u0440\u0435\u0434\u0441\u0442\u0432\u043e CleanUp","name":"\u0427\u0438\u0441\u0442\u044f\u0449\u0435\u0435 \u0441\u0440\u0435\u0434\u0441\u0442\u0432\u043e CleanUp"},"UA":{"price":"549.00","percent":"100","dostavka":"50","old_price":"1098","geo_code":"UA","geo_name":"\u0423\u043a\u0440\u0430\u0438\u043d\u0430","currency":"\u0433\u0440\u043d","currency_code":"UAH","description":"\u0427\u0438\u0441\u0442\u044f\u0449\u0435\u0435 \u0441\u0440\u0435\u0434\u0441\u0442\u0432\u043e CleanUp","name":"\u0427\u0438\u0441\u0442\u044f\u0449\u0435\u0435 \u0441\u0440\u0435\u0434\u0441\u0442\u0432\u043e CleanUp"},"KZ":{"price":"6990.00","percent":"100","dostavka":"1200","old_price":"13980","geo_code":"KZ","geo_name":"\u041a\u0430\u0437\u0430\u0445\u0441\u0442\u0430\u043d","currency":"\u0442\u0435\u043d\u0433\u0435","currency_code":"KZT","description":"\u0427\u0438\u0441\u0442\u044f\u0449\u0435\u0435 \u0441\u0440\u0435\u0434\u0441\u0442\u0432\u043e CleanUp","name":"\u0427\u0438\u0441\u0442\u044f\u0449\u0435\u0435 \u0441\u0440\u0435\u0434\u0441\u0442\u0432\u043e CleanUp"}}},"tel":[]};var footertext = 'ООО «МОНСТР-МЕДИА» ИНН 7701071884<br>ОГРН 1157746018870<br>г. Москва, пр-т. Ленинградский, д.80, корп. 1<br/><a onclick="javascript: cartPolitika();" style="cursor: pointer;">\u041F\u043E\u043B\u0438\u0442\u0438\u043A\u0430 \u043A\u043E\u043D\u0444\u0438\u0434\u0435\u043D\u0446\u0438\u0430\u043B\u044C\u043D\u043E\u0441\u0442\u0438 </a><br/><a href="http://monsterleads.pro/?utm_source=from_land" target="_blank">MonsterLeads.Pro</a>';function cartFrameInit(params) {
    console.log("init");
    ...
    ;
    iframe.src = 'http://c.cpam.pro/' + landing_id + '/frame?mleads=tpsEceGdidSFEczKDywEKTo9JyEJDYc8&t=' + parseInt(cartStartTime || 0) + '&product_id=' + product_id + (type !== '' ? '&type=' + type : '') + (params.subtype === 'fast_call' ? '&subtype=fast_call' : '') + (params.tel ? '&tel=' + encodeURIComponent(params.tel) : '');
...
function sendBaseEvent(event) {var http = new XMLHttpRequest();var url = "https://c.cpam.pro/39411/cross_query?&code=&geo_id=1&subid_id=&subid2_id=&subid3_id=&subid4_id=&subid5_id=&event_trigger=true&unique=1&event=" + event;var params = "";http.open("POST", url, true);http.onreadystatechange = function(){if (http.readyState == 4) {}};http.setRequestHeader("Content-type", "application/x-www-form-urlencoded");http.send(params);};try { (function (d, w, c) {
