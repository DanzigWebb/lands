$(function(){
    ...
    times = function(){         
        ...
        $('.timer-action').html('<span class="timer-col"><strong>' + hour + '</strong><br/><span>godzin</span></span><span class="timer-col"><strong>' + minu + '</strong><br/><span>minut</span></span><span class="timer-col"><strong>' + secu +'</strong><br/><span>sekund</span></span>');
    }   
    times();                                              
