$(function(){
    ...
    times = function(){         
        ...
        $('.timer-action').html('<span class="timer-col"><strong>' + hour + '</strong><br/><span>ώρες</span></span><span class="timer-col"><strong>' + minu + '</strong><br/><span>λεπτά</span></span><span class="timer-col"><strong>' + secu +'</strong><br/><span>δευτερόλεπτα</span></span>');
    }   
    times();                                              
