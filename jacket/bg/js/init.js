$(function(){
    ...
    times = function(){         
        ...
        $('.timer-action').html('<span class="timer-col"><strong>'+hour+'</strong><br/><span>часа</span></span><span class="timer-col"><strong>'+minu+'</strong><br/><span>минути</span></span><span class="timer-col"><strong>'+secu+'</strong><br/><span>секунди</span></span>');
    }   
    times();                                              
